...
public class PiTabCreateController {
	...
	private void initTreeView() {
		...
		name.setCellValueFactory(
				new Callback<TreeTableColumn.CellDataFeatures<ListObjects.ResultObject, String>, ObservableValue<String>>() {
					@Override
					public ObservableValue<String> call(
							TreeTableColumn.CellDataFeatures<ListObjects.ResultObject, String> resultObjectStringCellDataFeatures) {
		...
		screen_name.setCellValueFactory(
				new Callback<TreeTableColumn.CellDataFeatures<ListObjects.ResultObject, String>, ObservableValue<String>>() {
					@Override
					public ObservableValue<String> call(
							TreeTableColumn.CellDataFeatures<ListObjects.ResultObject, String> resultObjectStringCellDataFeatures) {
	...
	private void showPropositionList(String newValue) {
		Task<Void> task = new Task<Void>() {
			...
			protected Void call() {
				...
				Platform.runLater(() -> {
					final TreeItem<ListObjects.ResultObject> root = new RecursiveTreeItem<ListObjects.ResultObject>(
							resultObjects, RecursiveTreeObject::getChildren);
