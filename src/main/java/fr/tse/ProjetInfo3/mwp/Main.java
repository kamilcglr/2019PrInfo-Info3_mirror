...
public class Main extends Application {
	...
	public static void main(String[] args) {
		...
		/*
		 * TwitterAPP twitter = new TwitterAPP(); User test =
		 * twitter.getUserFromId("EmmanuelMacron"); String url =
		 * test.getProfileImageURL(); ImageIcon img = new ImageIcon(url);
		 * System.out.println(test.getScreenName());
		 * System.out.println(test.getStatus()); System.out.println(test.getId());
